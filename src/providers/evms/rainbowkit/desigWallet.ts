...
export const desigWallet = ({ chains, ...options }: DesigWalletOptions & InjectedConnectorOptions): Wallet => {
  return {
    id: "desig",
    name: "Desig Wallet",
    ...
    createConnector: () => {
      const getProvider = () => (typeof window !== "undefined" ? (window as any).desig?.ethereum : undefined);
        ...
        extension: {
          instructions: {
            steps: [
              ...
              {
                description: "Be sure to back up your account for added security and easy wallet recovery.",
                step: "create",
